package com.tianxiabuyi.txutils_ui.text;
...
public class TxAlignTextView extends AppCompatTextView {
    ...
    public TxAlignTextView(Context context) {
        this(context, null);
    }

    public TxAlignTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TxAlignTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TxAlignTextView);
        text = typedArray.getString(R.styleable.TxAlignTextView_txAlignText);
        suffixMode = typedArray.getInt(R.styleable.TxAlignTextView_txAlignSuffixMode, 0);
        typedArray.recycle();
    }
