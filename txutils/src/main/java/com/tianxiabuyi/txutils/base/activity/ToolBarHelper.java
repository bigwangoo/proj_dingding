...
public class ToolBarHelper {
    ...
    private void initToolBar() {
        View toolbar = mInflater.inflate(R.layout.tx_layout_toolbar, mContentView);
        mToolBar = (Toolbar) toolbar.findViewById(R.id.tx_toolbar);
        if (mToolBar == null) {
            TxLog.d("mToolBar == null");
        }
    }
