...
public class AutoFillEmailEditText extends android.support.v7.widget.AppCompatAutoCompleteTextView {
    ...
    private void initWidget(final Context context) {
        ...
        setAdapter(new EmailAutoCompleteAdapter(context, R.layout.tx_item_register_email, emails));
        //使得在输入1个字符之后便开启自动完成
        setThreshold(1);
    ...
    private class EmailAutoCompleteAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.tx_item_register_email, null);
