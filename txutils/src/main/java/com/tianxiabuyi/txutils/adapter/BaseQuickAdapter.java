...
package com.tianxiabuyi.txutils.adapter;
...
import com.tianxiabuyi.txutils.adapter.animation.AlphaInAnimation;
import com.tianxiabuyi.txutils.adapter.animation.BaseAnimation;
import com.tianxiabuyi.txutils.adapter.animation.ScaleInAnimation;
import com.tianxiabuyi.txutils.adapter.animation.SlideInBottomAnimation;
import com.tianxiabuyi.txutils.adapter.animation.SlideInLeftAnimation;
import com.tianxiabuyi.txutils.adapter.animation.SlideInRightAnimation;
import com.tianxiabuyi.txutils.adapter.listener.OnItemDragListener;
import com.tianxiabuyi.txutils.adapter.listener.OnItemSwipeListener;
...
/**
 * 请使用更高版本 https://github.com/CymChad/BaseRecyclerViewAdapterHelper
 */
@Deprecated
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private BaseViewHolder getLoadingView(ViewGroup parent) {
        if (mLoadingView == null) {
            return createBaseViewHolder(parent, R.layout.tx_def_loading_view);
        }
