 ...
 */
package com.tianxiabuyi.txutils.permissions;
 ...
 */
public class TxPermissionsManager {

  private static final String TAG = TxPermissionsManager.class.getSimpleName();
  ...
  private static TxPermissionsManager mInstance = null;

  public static TxPermissionsManager getInstance() {
    if (mInstance == null) {
      mInstance = new TxPermissionsManager();
    }
    return mInstance;
  }

  private TxPermissionsManager() {
  ...
  /**
   * This method notifies the TxPermissionsManager that the permissions have change. If you are making
